...
class Question(models.Model):
    course = models.ForeignKey(Course, on_delete=models.CASCADE)
    question_text = models.CharField(null=False, max_length=50, default='')
...
class Choice(models.Model):
    ...
    choice = models.CharField(null=False, max_length=30, default='')
    choice_correct = models.BooleanField(null=False, default=False)
